...
MusicManager.prototype.nextMusic = function(){
	...
	if (self.customList.length==0) {
		...
		} while(security<100 && !self.verifyMusic(music.weekdays, music.date_start, music.date_end, music.hour_start, music.hour_end, music.name));
		if(security>99){
...
MusicManager.prototype.verifyMusic = function( music_days, music_init, music_end, music_hour_start, music_hour_end, name ){
	var self = this;
	playlist = self.verifyIsPlaylistNormal();
	weekdays = self.verifyWeekDay(music_days);
	date = self.verifyDate(music_init, music_end);
	hour = self.verifyHour(music_hour_start, music_hour_end);
	/*/
...
MusicManager.prototype.verifyIsPlaylistNormal = function(){
		return true;
}
MusicManager.prototype.verifyHour = function( music_hour_start, music_hour_end ){
		var date = new Date();
		var now = date.getHours();
		var r =(now > music_hour_start && now < music_hour_end)? true: false;
		return r;
}
MusicManager.prototype.verifyWeekDay = function( music_days ){
		var date = new Date();
...
MusicManager.prototype.verifyDate = function( music_init, music_end ){
		var date = new Date();
