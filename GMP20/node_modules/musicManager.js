...
MusicManager.prototype.makeUpdateAvaiable = function ( hash ){ //Torna o update pelas novas musicas enviadas pelo servidor disponível para o cliente.
	var self = this;
...
MusicManager.prototype.downloadMusics = function( list, fromDir ){
	...
	if(next){
		...
		self.hasUpdateAvaiable = true;
		self.emit('download-completed');
		self.makeUpdateAvaiable( self.newHash );
		return;
	}
