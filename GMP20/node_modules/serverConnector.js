...
ServerConnector.prototype.loadList = function( ){
	...
	var req = http.request( options, function(res){
		...
		res.on('end', function() {
			try{				
				...
				//self.emit('quepare', JSON.parse(list));
			}catch(err) {
	...
	list = '{  '+
			   ...
			   '"audios":[  '+
				  '{  '+
					 '"audioid":"68",'+
					 '"name":"Padrada Alterada",'+
					 '"artist":"Romulo Fróes",'+
					 '"band":"",'+
					 '"album":"2a. Sessão: Saiba Ficar Quieto",'+
					 '"mood_velocity":"50",'+
					 '"mood_happy":"50",'+
					 '"path":"./uploads/audios/1422237052_941325970.ogg",'+
					 '"playlist":"playlist-misto",'+
					 '"type":"normal",'+
				  ...
				  '{  '+
					 '"audioid":"67",'+
					 '"name":"Se eu for Alterada",'+
					 '"artist":"Romulo Fróes",'+
					 '"band":"",'+
					 '"album":"2a. Sessão: Saiba Ficar Quieto",'+
					 '"mood_velocity":"50",'+
					 '"mood_happy":"50",'+
					 '"path":"./uploads/audios/1422221383_1755944650.ogg",'+
					 '"playlist":"playlist-misto",'+
					 '"type":"normal",'+
					 '"date_start":"2014-12-31",'+
					 '"date_end":"2200-12-31",'+
