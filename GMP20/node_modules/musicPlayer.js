...
function Channel( audio, crossTime, extra ){
	...
	if(!this.extra){
		...
		this.audio.onended 		= function(){ 
			console.log( "extra terminado");
			self.emit( 'extraEnded', self );
...
Channel.prototype._startFade = function( step, limit, isExtra ){
	var self = this;
	this.stopFade();
	var cross = (isExtra)? this.defaultFade : self.crossTime / 10;
